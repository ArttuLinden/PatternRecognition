...
#feats = ['fftlog10','mean','std','mean_std']
#feats = ['PSD','logPSD','fft','fftpow2','fftlog10',
#                 'fftlog10_all','fftmean_fftstd','fftmean_fftstd',
#                 'mean_std_fftmean_fftstd','max2fftpeaks','max3fftpeaks',
#                 'mean_std_max3fftpeaks',
#                 'fft2peaks_fftstd_fftmean','fft2peaks_fftstd_fftmean_mean_std']
feats = ['maxPCD_mean_std']
...
data = np.array(data)
np.save('feature_comparison_fft_all',data)
